...
export default function SettingsPage() {
  ...
  const handleLinkedInConnect = async () => {
    setLiLoading(true)
    const { error } = await supabase.auth.signInWithOAuth({ provider: 'linkedin_oidc', options: { scopes: 'openid profile email w_member_social r_basicprofile', redirectTo: `${window.location.origin}/auth/callback?next=/dashboard/settings` } })
